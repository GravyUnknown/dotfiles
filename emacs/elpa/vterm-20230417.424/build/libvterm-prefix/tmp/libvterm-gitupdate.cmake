...
execute_process(
  COMMAND "/usr/bin/git" show-ref "64f1775952dbe001e989f2ab679563b54f2fca55"
  WORKING_DIRECTORY "/home/user/.config/emacs/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/user/.config/emacs/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/user/.config/emacs/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
